...
The [next](https://github.com/Projjol/You-Dont-Know-JS/blob/patch/up%20%26%20going/ch2.md) chapter will review many of the concepts from this chapter, but from a more JavaScript-specific perspective, which will highlight most of the major topics that are addressed in deeper detail throughout the rest of the series.
