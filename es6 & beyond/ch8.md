...
在本书写作时，一个未来特性提案的列表和它们的状态可以在这里看到([https://github.com/tc39/ecma262#current-proposals](https://github.com/tc39/ecma262#current-proposals))。
...
这个转变很有可能将会很慢，会花上许多年成形。WASM在所有的主流浏览器上固定下来可能最快也要花几年。同时，WASM项目([https://github.com/WebAssembly](https://github.com/WebAssembly))有一个早期填补，来为它的基本原则展示概念证明。
