...
This isn't iterating over the values, though, but only over a numeric range [0..2], allowing you to use each number as an index to reference the value, as `myArray[i]`.
