...
Вернемся к примеру колбэка, который мы изучали в главе 1, немного изменим его:
...
Вы, возможно, заметили подвох и сказали: «Выполнится A, затем установится тайм-аут тайм-аут на 1000 миллисекунд, выполнится B, а затем, после того, как тайм-аут пройдет, выполнится C.». Это более точная формулировка, чем первая. Заметили разницу?
...
Я почти уверен, что большинство читателей слышали, как кто-то сказал (или даже сам утверждал): «Я — многозадачник». Многозадачность имеет множество проявелний — от юмористического (например, поглаживания головы-потирания живота) до обывательского (жевать жвачку при ходьбе) или до совершенно опасного (читать будучи за рулем).
...
Для вас это звучит так же подозрительно, как и асинхронный параллелизм (вроде того, что есть в JS)? Если нет, вернитесь и снова прочитайте главу 1!
...
Когда разработчик пишет код, он планируют выполнить ряд действий. Если это хороший разработчик, он тщательно планирует это. «Мне нужно установить переменной `z` значение `x`, а затем переменной `x` значение `y`» и так далее.
...
Шесть месяцев проходят без проблем. Вы почти забыли, что написали этот код. Однажды утром вы в кафе перед работой, наслаждаясь латте, получаете тревожный звонок от вашего босса, который настаивает на том, что вы выкидываете кофе и сразу бросаетесь на работу.

Придя на работу , вы узнаете, что у VIP-клиента была снята плата за один и тот же телевизор 5 раз, и он, понятно дело, расстроен. Служба поддержки клиентов уже извинилась и возместила ущерб. Но ваш босс требует знать, как это могло произойти. «Разве мы не протестировали этот кейс?»
...
Вы можете видеть, насколько быстро непредсказуемость Zalgo может угрожать любой программе на JS. Таким образом, глупо звучащее «никогда не выпускай Залго» на самом деле распространенный и полезный совет. Только асинхронность!
...
Колбэки могут решать самые разные задачи, но вы должны приложить много усилий, чтобы добиться этого. И часто это усилия требуют гораздо больше времени, чем задача которую этот колбэк выполняет.
