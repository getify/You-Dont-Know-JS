...
Если у вас есть код, использующий колбэки, не исключая сторонних утилит, и вы не применяете какую-то логику обработки инверсии контроля, ваш код имеет ошибки в нем прямо сейчас, хотя они возможно, не укусил вас. Скрытые ошибки по-прежнему являются ошибками.
