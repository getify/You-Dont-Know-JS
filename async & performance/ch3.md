...
Вы, несомненно, заметили, что промисы вообще не избавляются от колбэков. Они просто меняют место вызова колбэка. Вместо того, чтобы передавать колбэк foo (..), мы получаем что-то (якобы подлинное обещание) обратно из foo (..), и мы передаем обратный вызов тому что-то вместо этого.
