...
В асинхронной последвательности (цепочка промисов) только одна задача может обрабатываться в данный момент времени -- шаг 2 идет строго за шагом 1, а шаг 3 идет строго за шагом 2. Но как насчет выполнения двух или более шагов одновременно (или «параллельно»)?
